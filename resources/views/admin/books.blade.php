...
@section('page-subtitle', 'Kelola semua buku di perpustakaan')
...
<div class="stats-grid">
    ...
    <div class="stat-card">
        <div class="stat-value">{{ $books->sum('available') }}</div>
        <div class="stat-label">Tersedia</div>
    </div>
    <div class="stat-card">
        <div class="stat-value">{{ $books->sum('stock') - $books->sum('available') }}</div>
...
<div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 1.5rem;">
    <h2 class="card-title" style="margin-bottom: 0;">Daftar Buku</h2>
    <button class="add-book-btn" onclick="openAddModal()">+ Tambah Buku</button>
</div>
...
<div class="books-grid">
    ...
    <div class="book-card">
        <div class="book-cover">
            ...
            @else
            <span class="book-badge borrowed">✗ Habis</span>
            @endif
        ...
        <div class="book-content">
            ...
            <div class="book-meta">
                <span>Stok: {{ $book->stock }} | Tersedia: {{ $book->available }}</span>
            </div>
...
function openEditModal(id, title, author, categoryId, isbn, publisher, year, pages, stock, coverImage) {
    document.getElementById('editForm').action = '{{ route("admin.books.update", ":id") }}'.replace(':id', id);
