            ...
            <tr data-status="{{ $loan->status }}">
                ...
                <td>
                    ...
                    @elseif($loan->status == 'returned')
                        <span class="status-badge" style="background: #cce5ff; color: #004085;">✓ Dikembalikan</span>
                ...
                <td>
                    @if($loan->status == 'pending')
                        ...
                        <form action="{{ route('petugas.loans.reject', $loan->id) }}" method="POST" style="display: inline;">
                            @csrf
                            <button type="submit" class="btn-action btn-reject" onclick="return confirm('Tolak peminjaman ini?')">Tolak</button>
                        </form>
                    @elseif($loan->status == 'return_pending')
                        <form action="{{ route('petugas.loans.approve-return', $loan->id) }}" method="POST" style="display: inline;">
                            @csrf
                        ...
                        <form action="{{ route('petugas.loans.reject-return', $loan->id) }}" method="POST" style="display: inline;">
                            @csrf
