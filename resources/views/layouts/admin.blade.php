...
<body>
    <aside class="sidebar">
        ...
        <ul class="menu">
            ...
            <a href="{{ route('admin.officers') }}" class="menu-item {{ request()->routeIs('admin.officers') ? 'active' : '' }}">
                <span class="menu-icon">👨‍💼</span>
            ...
            <a href="{{ route('admin.loans') }}" class="menu-item {{ request()->routeIs('admin.loans') ? 'active' : '' }}">
                <span class="menu-icon">📖</span>
    ...
    <main class="main-content">
        <div class="top-bar">
            <div class="welcome">
                ...
                <p>@yield('page-subtitle', 'Berikut adalah ringkasan sistem Anda hari ini')</p>
            </div>
