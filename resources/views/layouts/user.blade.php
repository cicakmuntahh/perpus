...
<body>
    <aside class="sidebar">
        ...
        <ul class="menu">
            ...
            <a href="{{ route('user.catalog') }}" class="menu-item {{ request()->routeIs('user.catalog') ? 'active' : '' }}">
                <span class="menu-icon">📚</span>
                <span>Katalog Buku</span>
            </a>
            <a href="{{ route('user.loans') }}" class="menu-item {{ request()->routeIs('user.loans') ? 'active' : '' }}">
                <span class="menu-icon">📖</span>
                <span>Peminjaman Saya</span>
            </a>
            <a href="{{ route('user.history') }}" class="menu-item {{ request()->routeIs('user.history') ? 'active' : '' }}">
                <span class="menu-icon">📜</span>
                <span>Riwayat</span>
            </a>
        </ul>
    ...
    <main class="main-content">
        <div class="top-bar">
            <div class="welcome">
                <h1>@yield('page-title', 'Selamat Datang Kembali')</h1>
                <p>@yield('page-subtitle', 'Mari lanjutkan pembelajaran Anda hari ini')</p>
            </div>
